...
1. 添加视频或文件夹，也可以直接从访达拖入 Muralume
...
可以添加单个视频、添加本机或外置磁盘中的文件夹，也可以直接从访达拖入。Muralume 会递归发现文件夹中的 MP4、MOV 和 M4V 视频、在本地生成缩略图，并支持按名称、创建时间或文件大小排序，无需重新整理磁盘文件。若文件夹内容在访达中发生变化，可在播放列表中使用“编辑 → 刷新数据”重新扫描已经授权的来源
